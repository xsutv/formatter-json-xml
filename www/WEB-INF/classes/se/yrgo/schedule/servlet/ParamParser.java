...
public class ParamParser {
  ...
  // private int status; // Denna kan användas som en metod att sätta en variabel till statuskods typ ex SC_BAD_REQUEST
  ...
  private void parseContentType() {
    if (format != null && format.equalsIgnoreCase("json")) {
      ...
      throw new IllegalArgumentException("400 bad request - Format not supported.");
    }
  }
